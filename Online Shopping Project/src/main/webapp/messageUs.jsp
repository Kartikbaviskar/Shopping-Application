...
<body>
<div style="color: white; text-align: center; font-size: 30px;">Message Us <i class='fa fa-envelope-open-o'></i></div>
<%
...
<hr>
<button class="button" type="submit">Send <i class="far fa-attow-alt-circle-right"></i> </button>
</form>
<br><br><br>
</body>
</html>