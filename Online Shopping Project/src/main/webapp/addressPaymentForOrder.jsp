...
<div class="right-div">
<h3>Pay online on this baviskarkartik@pay.com</h3>
<input class="input-style" type="text" name="transactionId" placeholder="Enter Tranaction ID">
...
<button class="button" type="submit">Procced to Generate Bill & Save <i class='fa fa-arrow-circle-right'></i></button>
